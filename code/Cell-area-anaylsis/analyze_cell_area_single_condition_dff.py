"""Compute and plot DeltaA/A0 traces for one cell-area condition.

Supported input:
    data/time-series/cell-area/<condition>.parquet
...
def compute_dff(
    ...
    """Compute DeltaA/A0 per track_id from curated cell-area traces."""
...
def plot_dff(
    ...
    plt.figure()
    plt.plot(pop["time_s"], pop["mean"], label="Mean DeltaA/A0")
    plt.fill_between(
        pop["time_s"],
        pop["mean"] - pop["sem"],
        pop["mean"] + pop["sem"],
