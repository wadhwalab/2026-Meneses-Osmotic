...
# ================= USER PARAMETERS =================
folder_path = "/Users/luismeneses/ASU Dropbox/KE-TF Biodesign ME Wadhwa/Wadhwa Lab/Luis_M/Osmotic-shock-motor-response-project-2022-2025/Data/TMRM/2026-results/Combined/STD"  # <--- FOLDER containing all CSVs
...
combined_plot_path1 = os.path.join(
    folder_path, f"{folder_name}_population_dff_multi.pngf"
)
