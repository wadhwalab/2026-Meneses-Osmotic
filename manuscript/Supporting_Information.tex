...
\begin{figure*}
    ...
    \caption{\textbf{Motor speed decrease during a 100~mM hyperosmotic shock.} Population-averaged normalized rotation speed during exposure to 100~mM sucrose shock ($n$ = 11). Motor speed decreased upon addition of sucrose and remained reduced throughout the shock period, recovering upon return to base media. The shaded region indicates the duration of hyperosmotic exposure.} 
