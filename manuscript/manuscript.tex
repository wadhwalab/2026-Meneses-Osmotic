...
\begin{figure*}
    \centering
      \includegraphics[width=0.5\linewidth]{figures/quantification_TMRM.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/sorbitol-biophysics.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/sodium-biophysics.pdf}
...
\end{figure*}
 ...
 \begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/clockwise-biophyscis.pdf}
    \caption{\textbf{Motor speed reduction is independent of the direction of rotation.}
    (\textbf{A}) Population-averaged normalized rotation speed during 200--500~mM sucrose shocks in \textit{E. coli} cells locked in clockwise (CW) rotation ($n = 8, 8, 9, 8$ for 200, 300, 400, 500~mM, respectively). Rotation speeds were normalized to the mean pre-shock speed $\omega_{\mathrm{0}}$ for each condition, $\omega_{\mathrm{norm}}(t) = \omega(t)/\omega_{\mathrm{0}}$. The shaded region indicates the duration of hyperosmotic exposure.
...
\end{figure*}
 ...
 \begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/osmoadaption-biophysics.pdf}
